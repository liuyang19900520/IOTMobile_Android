...
public class Constants {
    ...
    // 微信精选Key
    public static final String WEIXIN_KEY = "d948bbe967b68edd16a97ec68127ca1d";
    ...
    public static final String PATH_DATA = IOTApplication.getInstance().getCacheDir().getAbsolutePath() + File.separator + "data";
