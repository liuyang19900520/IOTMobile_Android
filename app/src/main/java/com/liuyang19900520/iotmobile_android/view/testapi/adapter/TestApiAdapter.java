 ...
 * @author liuya
 */
public class TestApiAdapter extends BaseQuickAdapter<TestApi.Api, BaseViewHolder> {


    public TestApiAdapter(int layoutResId, @Nullable List<TestApi.Api> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, TestApi.Api item) {
